...
class PanelDetectionVotesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.augment:
            ...
            rot_mat = panelnet_utils.rotz(rot_angle)
        ...
        for i in range(bboxes.shape[0]):
            bbox = bboxes[i]
            corners_3d = panelnet_utils.my_compute_box_3d(bbox[0:3], bbox[3:6], bbox[6])
...
def get_sem_cls_statistics():
    ...
    # d = PanelDetectionVotesDataset(use_height=True, use_color=True, augment=True)
